...
void setup()
{
    ...
    {
        Serial.println("[NuSGenericAdvanced] WARNING: NuS UUID did not fit advertising data.");
    }
    ...
    if (!pAdvertising->setName("GenAdv-NuS"))
    {
        Serial.println("[NuSGenericAdvanced] WARNING: NuS alias did not fit scan response.");
    }
