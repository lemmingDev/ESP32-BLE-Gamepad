...
public:
    ...
    ~BleOutputReceiver();
    //void onWrite(NimBLECharacteristic *pCharacteristic) override;    // Compatible with 1.4.3
    void onWrite(NimBLECharacteristic *pCharacteristic);    // Compatible with over 1.4.3
